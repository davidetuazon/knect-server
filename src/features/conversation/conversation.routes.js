...
// router.get('/messages/:id', utils.authenticate, conversationController.getConversation);

router.get('/messages/:id', utils.authenticate, conversationController.geAllMessages);
